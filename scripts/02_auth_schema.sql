...
CREATE TABLE profiles (
    ...
    role TEXT CHECK (role IN ('SUPER_ADMIN', 'ANGGOTA_FOZ', 'GUEST', 'TIM_SEKRETARIAT', 'EXECUTIVE_FOZ', 'UNIT_LAYANAN_1', 'UNIT_LAYANAN_2', 'PENGURUS', 'PENGURUS_HARIAN', 'BIDANG', 'DIREKTUR_EKSEKUTIF')) DEFAULT 'ANGGOTA_FOZ',
    nama_lengkap TEXT,
